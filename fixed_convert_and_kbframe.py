...
class testconvert(ui.View):
    def __init__(self):
        ...
        self.w=ui.WebView(frame=(405,1,1,1))
        ...
        [self.add_subview(s) for s in [self.t1,self.t2,self.t3,self.w]]
    ...
    def draw(self):
       ...
       # print kb
        kb_self=self.convert_point(kb[0:2],None,self)
       # print kb_self
        ui.set_color((0,1,0,0.5))
        ui.fill_rect(kb_self[0]-10,kb_self[1]-10, kb[2]+20,kb[3]+20)
    ...
    def get_keyboard_frame(self):
        ...
        #TODO:  remove delendence on webview, use xaxis/yaxis to determine rotation instead
        ...
        o=self.w.eval_js('window.orientation')
        ...
        self.t3.text=('orientation {}\n'
                      ...
                      'kbframe fixed {}\n '
                      'kbframe in V  {}\n'
                      'xaxis {}\n yaxis {}').format(o,frame,fixedframe,self.convert_point(fixedframe[0:2],None,self),xaxis,yaxis)
        return fixedframe
